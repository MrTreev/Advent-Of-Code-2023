...
const std::array<const std::string, 9> number_words = {
...
int find_pair(std::string full_string) {
    ...
    logger.info("Words:" + std::to_string(first_word) +
                std::to_string(last_word) + "\tLine: " + full_string);
    ...
    logger.info("Number: " + std::to_string(first_word) +
                std::to_string(last_word) + "\tLine: " + full_string);
